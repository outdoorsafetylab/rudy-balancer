...
func (x *GetVersionResponse) GetTag() string {
	if x != nil {
		return x.Tag
	}
	return ""
...
var file_api_version_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x03, 0x61, 0x70, 0x69, 0x22, 0x3e, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x56,
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10,
	...
	0x52, 0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x61, 0x70,
...
var file_api_version_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_version_proto_goTypes = []interface{}{
	(*GetVersionResponse)(nil), // 0: api.GetVersionResponse
}
